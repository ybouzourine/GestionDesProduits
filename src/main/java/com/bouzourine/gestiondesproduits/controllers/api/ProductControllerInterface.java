...
public interface ProductControllerInterface {
    ...
    ResponseEntity<ProductResponseDto> getById(@Parameter(description = "id of book to be searched") Long id);
    ...
    ResponseEntity<ProductResponseDto> update(@Parameter(description = "id of book to be updated.") Long id,@RequestBody(description = "product to be updated.") ProductUpdateDto productUpdateDto);
    ...
    ResponseEntity<Void> delete(@Parameter(description = "id of book to be deleted.") Long id);
}